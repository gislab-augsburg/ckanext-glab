...
##from ckan.views import dataset as dataset_view, resource  # noqa: F401  ??? Guess not needed ???
...
class MyCoolPlugin(SingletonPlugin):
...
##        intercepts.set_intercepts()
    ...
    # IMiddleware ??? gues not needed (module urlm)
...
##        return app
    ...
    # IBlueprint ??? not needed ??? not sure
##    def get_blueprint(self):
##        """
